...
class WeightFile extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('weight_file');
        $table->addColumn('name', 'string', array('limit' => 30, 'default' => '', 'comment' => '标题'))
            ->addColumn('filename', 'string', array('limit' => 200, 'default' => '', 'comment' => '文件名'))
            ->addColumn('path', 'string', array('limit' => 200, 'default' => '', 'comment' => '文件地址'))

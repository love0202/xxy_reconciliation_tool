...
class PddFile extends Migrator
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        $table->addColumn('name', 'string', array('limit' => 30, 'default' => '', 'comment' => '标题'))
            ...
            ->addColumn('order_manual_filename', 'string', array('limit' => 200, 'default' => '', 'comment' => '手工订单文件名'))
            ->addColumn('order_manual_path', 'string', array('limit' => 200, 'default' => '', 'comment' => '手工订单文件地址'))
            ->addColumn('num_manual', 'integer', array('limit' => 10, 'default' => 0, 'comment' => '导入手工订单商品行数'))

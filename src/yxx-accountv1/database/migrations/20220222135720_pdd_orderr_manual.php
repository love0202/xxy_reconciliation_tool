...
class PddOrderrManual extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('pdd_order_manual');
        $table->addColumn('pdd_file_id', 'integer', array('limit' => 10, 'default' => 0, 'comment' => 'pdd_file表ID'))

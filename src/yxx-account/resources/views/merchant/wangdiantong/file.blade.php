...
@section('content')
    <div class="mb-3">
        <div class="row g-3">
            <div class="col-auto">
                <a href="{{ route('merchant.wangdiantong.create') }}" class="btn btn-success text-light">
            ...
            <tr>
                ...
                <td>
                    ...
                    @foreach ($fileArr as $f)
                        <p class="m-0"><span class="fw-bold">原文件名【导入数量】：</span>{{$f['originalName']}}
                            【{{$f['importNum']}}】</p>
                ...
                <td>{{ $l->created_at }}</td>
                <td>
                    <a href="{{ route('merchant.wangdiantong.index',['file_id'=>$l->id]) }}" class="btn btn-outline-primary btn-sm">
...
@section('script')
    <x-modal.table-delete id="table-delete" url="{{ route('merchant.wangdiantong.ajax_destroy_file') }}"/>
@endsection

...
@section('content')
    <div class="mb-3">
        <form method="POST" action="{{ route('merchant.pinduoduo.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="row mb-3">
                <label for="inputPassword3" class="col-sm-2 col-form-label">模板类型</label>
                <div class="col-sm-10">
                    <select name="type" class="form-select">
                        <option value="1" selected>手工订单模板</option>
                        <option value="2">已发货订单模板</option>
                    </select>
                    @error('type')
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="yxx-input-desc mt-3">
                        <p class="m-0">文件说明：</p>
                        <p class="m-0">1. 请下载【商户】拼多多手工订单模板：<a href="{{ yxx_path_static('【商户】拼多多手工订单模板.xlsx','templates') }}">【商户】拼多多手工订单模板.xlsx</a>，根据模板中提示进行填写；</p>
